#
# Created by NUZEROVI on 2022/12/09.
#
...
class Ui_MainWindow(object):
    ...
    def fit(self):
        ...
        for i in range(len(init._V)):  #len(init._V)
            ...
            Φ = (initPara.k * float(self.txt_deault_T.text()) / initPara.q) * np.log(initPara.sn * initPara.nth * initPara.Nc * (1 / τit))
        ...
        try:
            writer = pd.ExcelWriter('BestFit.xlsx', engine='xlsxwriter')
    ...
    def output_GP_W(self):
        ...
        try:
            ...
            writer = pd.ExcelWriter('Gp_W_Results.xlsx', engine='xlsxwriter')
            df.to_excel(writer, sheet_name='Sheet1', index=False)
            writer.save()
            # aa = pd.read_excel('./Gp_W_Results.xlsx')
            # print(aa)
            QMessageBox.information(None, 'Message', 'Finished')
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "BestFit_App"))
