...
class Ui_MainWindow(object):
    ...
    def change_default(self):
        ...
        print(
            str(initPara.k) + ", " + str(initPara.q) + ", " + str(initPara.sn) + ", " + str(initPara.nth) + ", " + str(
                initPara.Nc) + ", " + str(initPara.T))
    ...
    def cal_BestFit_GP_W(self, maxτ, maxD):
        ...
        for j in range(len(init._Freq)):
            w = init._W[j]
            Theoretical_Gp_W_Best.append((q * w * τit * Dit) / (1 + (math.pow(w * τit, 2))))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "BestFit_App_v2"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Input Files"))
        self.label.setText(_translate("MainWindow", "Excel Files :"))
